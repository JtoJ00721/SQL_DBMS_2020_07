...
-- DEFAULT
-- 해당하는 칼럼의 데이터를 지정하지 않고 INSERT 수행하면
...
------------------------------------
-- 성적정보 table를 활용한  SELECT
------------------------------------

-- 학생별 총점과 평균을 계산하여 리스트로 확인하기
...
-- SELECTION 을 적용하여 구현
-- 학번이 20001 ~ 20010까지 학생의 리스트만 보고 싶을 때
SELECT * FROM tbl_score
...
--      통계, 집계함수를 사용할떄 통계, 집계 함수로 묶이지 않은 칼럼은 
...
UNION ALL -- ; 으로 맺지않은 SELECT 절을 이어준다
